...
public class FragmentMap extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (MainActivity.lastPosition != null) {
            mMap.addMarker(new MarkerOptions().position(MainActivity.lastPosition).title("Вы тут"));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(MainActivity.lastPosition));
        }
    }
